...
import com.kusamaru.standroid.tool.AnniversaryDate
import com.kusamaru.standroid.tool.calcAnniversary
 ...
 * */
class NicoVideoHistoryListAdapter(val nicoVideoDataList: LinkedHashSet<NicoVideoData>, private val isUseComposeAndroidView: Boolean = false) : RecyclerView.Adapter<NicoVideoHistoryListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NicoVideoHistoryListAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: NicoVideoHistoryListAdapter.ViewHolder, position: Int) {
        val data = nicoVideoDataList.elementAt(position)
        holder.apply {
                ...
                when (playType) {
                    "default" -> {
                        ...
                        (context as? MainActivity)?.setNicovideoFragment(
                            ...
                            _videoList = if (isDefaultPlaylistMode) nicoVideoDataList.toCollection(ArrayList()) else null
                        )
                    }
                    "popup" -> {
