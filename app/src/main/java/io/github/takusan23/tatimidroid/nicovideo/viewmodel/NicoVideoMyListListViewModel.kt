...
/**
 * マイリストの動画を表示するFragment[io.github.takusan23.tatimidroid.nicovideo.fragment.NicoVideoMyListListFragment]で使うViewModel
 *
...
class NicoVideoMyListListViewModel(application: Application, private val myListId: String, private val isMe: Boolean) : AndroidViewModel(application) {
    ...
    /**
     * ソートする
     * @param sortNumber [io.github.takusan23.tatimidroid.nicovideo.fragment.NicoVideoMyListListFragment.initSortMenu]参照。
     * */
